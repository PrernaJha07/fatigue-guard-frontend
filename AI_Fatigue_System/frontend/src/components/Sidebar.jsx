...
const Sidebar = () => {
  ...
  return (
    <aside className="h-screen w-64 bg-white border-r border-slate-200 flex flex-col p-6 shadow-sm sticky top-0">
      {/* Branding */}
      ...
      <div className="border-t border-slate-100 pt-6 mb-2">
        <div className="flex items-center gap-3 px-4 py-2 mb-2">
          ...
          <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white text-sm font-bold uppercase shadow-inner">
